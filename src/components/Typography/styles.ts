...
export const parsedTypographys = {
  ...
  strong1: {
    ...
    style: css`
      color: ${props => props.theme.white};
      font-size: ${typography.s1.size};
      font-weight: ${typography.s1.weight};
    `,
  },
  body1: {
    tag: 'p',
    style: css`
      color: ${props => props.theme.white};
      font-size: ${typography.b1.size};
      font-weight: ${typography.b1.weight};
    `,
  },
  body2: {
    tag: 'p',
    style: css`
      color: ${props => props.theme.white};
      font-size: ${typography.b2.size};
      font-weight: ${typography.b2.weight};
    `,
  },
  caption: {
    tag: 'span',
